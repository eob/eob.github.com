...
of the game create a calculable expected return for every possible angle from
which you shoot these balls. This means the game boils down to guessing what
these expected payouts are and holding your wrist at precisely the angle that
that achieves them.
